...
**
** Created: Wed Apr 30 14:18:14 2014
...
static const char qt_meta_stringdata_StartMenu[] = {
    "StartMenu\0\0hideAll()\0twoAct()\0threeAct()\0"
    "fourAct()\0"
};
...
const QMetaObjectExtraData StartMenu::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject StartMenu::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StartMenu,
      qt_meta_data_StartMenu, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &StartMenu::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StartMenu))
